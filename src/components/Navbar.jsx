...
<div className="navBar">
    ...
    <div className={isActive ? "menu " : "menu display"} onClick={InWidth}>
        ...
        <NavLink to="/adminPolancoMuebles"             > QR      </NavLink>
        <NavLink to="/adminPolancoMuebles/inventario"   > Inventario </NavLink>
      {/*  <NavLink to="/adminPolanco/ordersHillo"  > Ordenes Hermosillo</NavLink>
        ...
        <NavLink to="/adminPolancoMuebles/entregas"> Entregas</NavLink>
