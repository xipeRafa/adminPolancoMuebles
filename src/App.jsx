  ...
  return (
    <div className='containerApp'>
        ...
        <div className="titleLogo">
          <h2 className="w50">Polanco Muebles Admin System</h2>
      </div>
      <Navbar />
      ...
      <Routes>
        <Route path="/adminPolancoMuebles" exact element={
                <Inicio arr={arr} setGetArr={setGetArr} getArr={getArr} UpdateByIdInventario={UpdateByIdInventario} postVentas={postVentas} /> 
        } />

        <Route path="/adminPolancoMuebles/inventario" element={<Inventario arr={arr} setGetArr={setGetArr} getArr={getArr}/>} />
         <Route path="/adminPolanco/inventarioMuebles/:id" element={<Inventario arr={arr} setGetArr={setGetArr} getArr={getArr}/>} />
     ...
     {/*   <Route path="/adminPolanco/ordersHillo" element={<OrdersHillo arrOrders={arrOrders} setGetArrOrders={setGetArrOrders} getArrOrders={getArrOrders}/>} />
        ...
        <Route path="/adminPolancoMuebles/entregas" element={<Entregados arrVentas={arrVentas} setGetArrVentas={setGetArrVentas} getArrVentas={getArrVentas}/>} />

        <Route path="*"  element={<Navigate to='/adminPolancoMuebles' />}/> 
      </Routes>
    </div>
  );
}
